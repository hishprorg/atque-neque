...
<p align="center">
  <a href="https://gitpod.io/#https://github.com/hishprorg/atque-neque"><img alt="Gitpod ready-to-code" src="https://img.shields.io/badge/Gitpod-ready--to--code-blue?logo=gitpod"></a>
</p>
<p align="center">
    <a href="https://www.npmjs.com/package/@hishprorg/atque-neque"><img alt="v7 npm Downloads" src="https://img.shields.io/npm/dm/@hishprorg/atque-neque.svg?maxAge=43200&label=v7%20downloads"></a>
...
<p align="center">
  <a href="https://github.com/hishprorg/atque-neque/actions/workflows/ci.yml"><img alt="GitHub CI Status" src="https://github.com/hishprorg/atque-neque/actions/workflows/ci.yml/badge.svg?branch=main"></a>
  <a href="https://codecov.io/github/hishprorg/atque-neque"><img alt="Coverage Status" src="https://img.shields.io/codecov/c/github/hishprorg/atque-neque/main.svg?maxAge=43200"></a>
...
Please read through our [CONTRIBUTING.md](CONTRIBUTING.md) and fill out the issue template at [babel/issues](https://github.com/hishprorg/atque-neque/issues)!
...
- Issues with the [good first issue](https://github.com/hishprorg/atque-neque/labels/good%20first%20issue) and [help wanted](https://github.com/hishprorg/atque-neque/labels/help%20wanted) label. We suggest also looking at the [closed ones](https://github.com/hishprorg/atque-neque/issues?utf8=%E2%9C%93&q=is%3Aclosed+label%3A%22good+first+issue%22) to get a sense of the kinds of issues you can tackle.
